...
void calcAirportTraffic(const List &cities, int index);
void calcDistance(const List &cities, int index1, int index2,
                  int *distance, int *passengers, bool display);
void cleanCities(List &cities);
int findAirport(const List &cities, const char *airport);
void readAirports(List &cities);
void readCities(List &cities);
...
void calcDistance(const List &cities)
{
...
void determineAirportTraffic(const List &cities)
{
    char airport[80];
    int index;
...
void determineBestPlane(const List &cities, const Plane *planes,
                        int planeCount)
{
    char airport1[80], airport2[80];
...
void run(const List &cities, Plane *planes, int planeCount)
{
    int choice;
